        ...
        <div id="page-inner">
            <form class="form-horizontal" id="formEntrada" method="post">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input id="entrada" name="entrada" maxlength="200" type="text" placeholder="Nome"
                               class="form-control input-md" readonly="readonly" value="<?= date("d/m/Y H:m:s") ?>">
                    </div>
                </div>
                ...
                <div class="form-group aparece">
                    ...
                    <div class="col-md-4">
                        <input id="placa" name="placa" type="text" maxlength="45" placeholder=""
                ...
                <div class="form-group">
                    <div class="col-md-7" style="text-align: right">
                        ...
                        <button class="btn btn-info  " id="config" onClick="webcam.configure()"><i
                                class="fa fa-cog"></i></span> Configuração de camera
                        </button>
                        <button class="btn btn-success  " id="tirarfoto"><i class="fa fa-camera"></i></span> Tirar foto
                        </button>
                        <button id="salvar" name="salvar" class="btn btn-primary  aparece"><span
