...
<head>
    ...
    <script type="text/javascript" src="../public/js/funcionario.js"></script>
</head>
<body>
<div id="wrapper">
    <?php
    ...
    <div id="page-wrapper">
        <div id="page-inner">
            ...
            ?>
            <div data-alerts="alerts" data-titles="{&quot;warning&quot;: &quot;&lt;em&gt;Atenção!&lt;/em&gt;&quot;}"
                 data-ids="myid" data-fade="6000"></div>
            <div data-alerts="alerts" data-titles="{&quot;success &quot;: &quot;&lt;em&gt;Atenção!&lt;/em&gt;&quot;}"
                 data-ids="myid" data-fade="6000"></div>
            <fieldset>
                <form method="post" id="formAlterarSenha" class="form-horizontal">
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="senhaAntiga" name="senhaAntiga" type="password" placeholder=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <input id="cosenha" name="cosenha" type="password" placeholder=""
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4 ">
                                <button type="submit" name="alterarPasss" id="alterarPasss"
                                        class="btn btn-warning btn-lg pull-right"><span
                                        class="fa fa-pencil-square-o"></span>Alterar
                                </button>
                            </div>
                        </div>
                    </div>
